...
export async function processTextMessage(
  ...
  if (lowerMessage.includes("test") || lowerMessage.includes("testing")) {
    return {
      response:
        "I understand you're asking about testing. HIV testing is confidential and available at many locations. Modern tests are highly accurate and can detect HIV as early as 2-4 weeks after exposure. Would you like information about where to get tested, or do you have questions about test results?",
      suggestions: [
  ...
  if (lowerMessage.includes("prep") || lowerMessage.includes("prevention")) {
    return {
      response:
        "PrEP (Pre-Exposure Prophylaxis) is a daily medication that can significantly reduce your risk of getting HIV. When taken consistently, it's up to 99% effective. It's available by prescription from healthcare providers. Would you like to know more about how to start PrEP or whether it might be right for you?",
      suggestions: [
        "How do I start PrEP?",
  ...
  if (lowerMessage.includes("treatment") || lowerMessage.includes("medication")) {
    return {
      response:
        "Modern HIV treatment is highly effective. With proper medication, people living with HIV can live long, healthy lives and achieve an undetectable viral load, which means they can't transmit HIV to others. Treatment is often covered by insurance, and there are assistance programs available. What would you like to know about treatment?",
      suggestions: [
  ...
  return {
    response:
      "Thank you for reaching out. I'm here to provide you with compassionate, confidential support and information about HIV care. Whether you have questions about testing, prevention, treatment, or living with HIV, I'm here to help. What would you like to know more about?",
    suggestions: [
      "What should I do if I think I've been exposed?",
      "How accurate are HIV tests?",
      "What is PrEP?",
 ...
 */
export function generateSuggestions(context: string): string[] {
